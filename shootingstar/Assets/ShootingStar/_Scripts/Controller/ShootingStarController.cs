...
namespace PeixeAbissal.Controller {
    ...
    public class ShootingStarController : MonoBehaviour {
        ...
        private const float MAX_ROTATION_ANGLE = 70;
        ...
        private Vector2 GetPosition (float t) {
            ...
            return Vector3.Lerp (startingPoint.anchoredPosition + Vector2.right * xCurve.Evaluate (t) * CURVE_PIXEL_INTENSITY +
                Vector2.up * yCurve.Evaluate (t) * CURVE_PIXEL_INTENSITY,

                endPoint.anchoredPosition + Vector2.right * xCurve.Evaluate (t) * CURVE_PIXEL_INTENSITY +
                Vector2.up * yCurve.Evaluate (t) * CURVE_PIXEL_INTENSITY, t);
        }
